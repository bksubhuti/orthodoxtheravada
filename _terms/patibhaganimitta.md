---
layout: single
title: "Paṭibhāganimitta"
pali_spelling: "Paṭibhāganimitta"
category: "doctrinalConcept"
frequency_rank: 179
cross_links: ["nimitta", "uggahanimitta", "upacarasamadhi", "jhana"]
canonical_texts: ["Patisambhidamagga"]
commentaries: ["Visuddhimagga", "Abhidhammatthasangaha"]
---
Verified
### Grammatical Analysis
**Paṭibhāganimitta**: [nt.] counterpart sign; conceptualized image; reflex image. Formed by prefix *paṭi* (against, counter, matching) + *bhāga* (portion, part) + *[nimitta](/glossary/nimitta/)* (sign). Meaning: the purified, conceptual counterpart to the learning sign.
...
### Textual References
* **Textual**: *Abhidhammattha-saṅgaha* (Chapter IX, Nimittabhedavaṇṇanā) – Defining the counterpart sign (paṭibhāganimitta) as the object of access and absorption concentration.
