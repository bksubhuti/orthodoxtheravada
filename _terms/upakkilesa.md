...
layout: single
title: "Upakkilesa"
pali_spelling: "Upakkilesa"
category: "doctrinalConcept"
frequency_rank: 116
cross_links: ["kilesa", "citta", "nivarana", "vipassana"]
...
In the *Vatthūpama Sutta*, the Buddha maps a list of **sixteen upakkilesas**, which include:
Covetousness (*abhijjhā-visamalobha*), ill-will (*byāpāda*), anger (*kodha*), resentment (*upanāha*), contempt (*makkha*), insolence (*paḷāsa*), envy (*issā*), avarice (*macchariya*), deceit (*māyā*), fraud (*sāṭheyya*), obstinacy (*thambha*), rivalry (*sārambha*), conceit (*māna*), arrogance (*atimāna*), vanity (*mada*), and negligence (*pamāda*).
