...
layout: single
title: "Dhātukathā"
pali_spelling: "Dhātukathā"
category: "historicalContext"
frequency_rank: 310
cross_links: ["abhidhamma-pitaka", "dhammasangani", "vibhanga", "dhatu"]
canonical_texts: ["Dhatukatha"]
commentaries: ["Dhatukatha-atthakatha"]
---

Verified

### Grammatical Analysis
**Dhātukathā**: [f.] Discourse on Elements. Formed by *[dhātu](/glossary/dhatu/)* (element) + *kathā* (talk, discourse).

### Orthodox Definition
The *Dhātukathā* is the third book of the [Abhidhamma](/glossary/abhidhamma/) Piṭaka. It is a highly specialized, technical manual designed to test a scholar's mastery of the first two Abhidhamma books.

The text takes all the phenomena listed in the *[Dhammasaṅgaṇī](/glossary/dhammasangani/)* matrix and rigorously cross-examines them against the fundamental Buddhist taxonomy: the 5 aggregates (*[khandha](/glossary/khandha/)*), the 12 sense bases (*[āyatana](/glossary/ayatana/)*), and the 18 elements (*[dhātu](/glossary/dhatu/)*). 
...
> 
> — [Dhātukathā-aṭṭhakathā](/glossary/dhatukatha-atthakatha/) (Pañcapakaraṇa-aṭṭhakathā)
