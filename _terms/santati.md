...
layout: single
title: "Santati"
pali_spelling: "Santati"
category: "doctrinalConcept"
frequency_rank: 334
cross_links: ["upacaya", "jarata", "aniccata", "tilakkhana"]
...
1. **As a Material Phenomenon**: In Abhidhamma, *rūpassa santati* is the second characteristic of matter. Following the initial integration (*[upacaya](/glossary/upacaya/)*), *santati* is the continuous, unbroken generation of subsequent material groups throughout a lifetime, maintaining the body's form. 
2. **As the Great Illusion**: The *Visuddhimagga* states that *Santati* (continuity) is the primary illusion that conceals the mark of impermanence (*anicca-lakkhaṇa*). Because mind and matter arise and vanish so incredibly fast, the "gap" between them is invisible to the untrained mind. The illusion of *santati* makes phenomena appear as a solid, enduring self, much like a rapidly spinning firebrand appears as a solid circle of fire. Insight meditation is explicitly designed to break the illusion of *santati*.
