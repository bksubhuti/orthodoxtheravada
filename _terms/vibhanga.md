...
1. **Suttantabhājanīya**: Analyzing the topic using conventional Sutta terminology.
2. **Abhidhammabhājanīya**: Analyzing the same topic using the strict, ultimate terminology of the *Dhammasaṅgaṇī*.
