...
layout: single
title: "Samādhi"
pali_spelling: "Samādhi"
category: "doctrinalConcept"
frequency_rank: 12
cross_links: ["jhana", "samatha", "sati", "sammasamadhi", "ekaggata"]
...
### Orthodox Definition
*Samādhi* is defined in the [Abhidhamma](/glossary/abhidhamma/) as the mental factor of one-pointedness (*[ekaggatā](/glossary/ekaggata/)-cetasika*) when it accompanies a wholesome or beautiful consciousness (*sobhana-citta*). It functions to prevent mental scattering, bringing about an unperturbed, luminous, and workable state of mind.
...
2. *Upacāra-samādhi* (Access concentration): A deep state of concentration where the five hindrances (*[nīvaraṇa](/glossary/nivarana/)*) are fully suppressed, closely approaching the boundary of absorption, though the mental factors are not yet fully stabilized.
...
### Textual References
* **[Sutta](/glossary/sutta/)**: *Culavedalla Sutta* (MN 44) – Where the standard definitions of concentration, its objects, and its requisites are explicitly stated.
* **[Abhidhamma](/glossary/abhidhamma/)**: *[Dhammasaṅgaṇī](/glossary/dhammasangani/)* (Factors of the First [Citta](/glossary/citta-base/)).
* **Commentary**: *[Visuddhimagga](/glossary/visuddhimagga/)* (Part I - Concentration, Chapters III to XI) – Detailing the forty traditional subjects of meditation (*kammaṭṭhāna*).
