...
frequency_rank: 111
cross_links: ["kilesa", "avijja", "tanha", "arahat", "oghā"]
canonical_texts: ["Majjhima Nikaya", "Dhammasangani"]
commentaries: ["Atthasalini", "Papancasudani"]
---
...
### Orthodox Definition
The *Āsavas* are the deepest, most deeply ingrained toxic defilements that continuously "flow" out of the untrained mind, intoxicating beings and keeping them bound to [saṃsāra](/glossary/samsara/). The absolute destruction of these taints (*āsavakkhaya*) is the exact definition of Arahatship.
...
### Textual References
* **[Sutta](/glossary/sutta/)**: *Sabbāsava Sutta* (MN 2) – The Buddha’s masterclass on the seven specific methods for abandoning the influxes (by seeing, restraining, using, enduring, avoiding, removing, and developing).
* **[Abhidhamma](/glossary/abhidhamma/)**: *[Dhammasaṅgaṇī](/glossary/dhammasangani/)* (Āsava-gocchaka division).
* **Commentary**: *[Papañcasūdanī](/glossary/papancasudani/)* – Detailed mapping of how each influx is destroyed by specific stages of awakening.