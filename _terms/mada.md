...
frequency_rank: 127
cross_links: ["pamada", "mana", "upakkilesa"]
...
### Orthodox Definition
*Mada* is a minor defilement (*[upakkilesa](/glossary/upakkilesa/)*) representing a state of psychological intoxication. It is not intoxication via alcohol, but the deep, blinding vanity that arises when a person becomes obsessed with their own worldly advantages.

The Buddha frequently isolated **three specific types of intoxication**:
1. *Yobbana-mada*: Intoxication with youth (forgetting that the body will inevitably age).
