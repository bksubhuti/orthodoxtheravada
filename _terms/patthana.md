...
layout: single
title: "Paṭṭhāna"
pali_spelling: "Paṭṭhāna"
category: "historicalContext"
frequency_rank: 314
cross_links: ["abhidhamma-pitaka", "paticcasamuppada", "kamma"]
...
### Orthodox Definition
The *Paṭṭhāna* is the seventh, final, and by far the most massive book of the [Abhidhamma](/glossary/abhidhamma/) Piṭaka. It is traditionally referred to as the *Mahāpakaraṇa* (The Great Treatise). 

While the *[Dhammasaṅgaṇī](/glossary/dhammasangani/)* dissects the universe into ultimate realities, the *Paṭṭhāna* puts the universe back together by showing exactly how these realities condition one another. It establishes a complex system of **24 Conditions** (*paccaya*)—such as root condition, object condition, contiguity condition, [kamma](/glossary/kamma/) condition, and presence condition. 
...
* **Commentary**: *Paṭṭhāna-aṭṭhakathā* – Providing the classic similes for each condition (e.g., the object condition is like a walking stick for a blind man; the [kamma](/glossary/kamma/) condition is like a seed).